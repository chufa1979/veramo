...
<div class="contenido_detalle">
    <div class="main">
      <form id="form1" name="form1" method="post" action="pedir.php" onsubmit="return checkRadios(this);">
        <div class="ruta">Inicio  &raquo; <?php echo ucwords(strtolower($row_rs_cate_ver['categoria'])); ?>  &raquo; <strong><?php echo $row_rs['nombre']; ?></strong></div>
        
        <div id="producto_detalle">
          <span class="prod_nombre"><?php echo $row_rs['nombre']; ?></span><br />
          <div class="prod_art">Art. <?php echo $row_rs['articulo']; ?></div>
          <br />
		  <div id="prod_imagen"><img src="../<?php echo $row_rs['imagen1']; ?>" alt="<?php echo $row_rs['nombre']; ?>" name="imagesource" id="imagesource" /></div>
          <div id="fotitos">
        ...
        <div class="prod_colores">
            ...
            <div class="prod_precios">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <?php } ?></td>
                  <td align="left" class="prod_precio_unid"><?php if (($row_rs['precio2']<>'') && ($row_rs['precio2']<>0)) { ?>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="150" align="left" valign="top"><?php if ($row_rs['talle_s']==1){ ?>
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                  ...
                  <?php } ?></td>
                <td align="left" valign="top"><?php if ($row_rs['talle_1']==1){ ?>
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="40"><?php echo $row_rs['m8']; ?></td>
                        <td><select name="talle_1" class="cant_prenda" id="talle_1">
                          <option value="0" selected="selected">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                  ...
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><select name="talle_2" class="cant_prenda" id="talle_2">
                          <option value="0" selected="selected">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                  ...
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><select name="talle_3" class="cant_prenda" id="talle_3">
                          <option value="0" selected="selected">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                  ...
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><select name="talle_4" class="cant_prenda" id="talle_4">
                          <option value="0" selected="selected">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                  ...
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><select name="talle_5" class="cant_prenda" id="talle_5">
                          <option value="0" selected="selected">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                  ...
                  <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><select name="talle_6" class="cant_prenda" id="talle_6">
                          <option value="0" selected="selected">0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
